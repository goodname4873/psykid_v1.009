...
| 学生 | S440305200801011234 | 011234 | 测试新生 | 高一6班 |
| 学生 | S350102201104225576 | 225576 | 潘sir | ★ 初二13班（主要测试对象，含丰富对话和语音数据） |
| 学生 | S350426200809112042 | 112042 | 林 | 未知年级 |

> **新增学生**：教师登录后进入「学生管理」页面，点击"添加学生"即可，初始密码自动设为学籍号后6位。
>
> **密码规则**：S20240001-03 三位初始学生密码为 `student123`；S440305200801011234 / 潘sir / 林三位后添加的学生密码为学籍号后6位。
