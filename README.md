...
| 学生 | S440305200801011234 | student123 | 测试新生 | 高一6班 |
| 学生 | S350102201104225576 | student123 | 潘sir | ★ 初二13班（主要测试对象，含丰富对话和语音数据） |
| 学生 | S350426200809112042 | student123 | 林 | 未知年级 |

> **新增学生**：教师登录后进入「学生管理」页面，点击"添加学生"即可。新学生初始密码为学籍号后6位。
>
> **密码规则**：以上 6 位初始测试学生密码统一为 `student123`。通过教师端新增的学生初始密码为学籍号后6位。
